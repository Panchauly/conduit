...
|------|-----------|-----------------|
| **1. Storage adapters** | speak each target store's own wire protocol (SQLite, Postgres, MySQL, Redis, MongoDB, Neo4j) | **Dependencies are forced** — the client already runs these databases; Conduit must speak them |
